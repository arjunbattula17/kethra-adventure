...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Yo(e,t,n){let r=new Float32Array(Fo),i=new U(0,1,0);return new fa({name:`SphericalGaussianBlur`,defines:{n:Fo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Qo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Xo(){return new fa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Qo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Zo(){return new fa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Qo(),fragmentShader:`
	...
	`}var $o=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Hi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=gc(i,i.VERTEX_SHADER,y),S=gc(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Sc(i,x,`vertex`),n=Sc(i,S,`fragment`);z(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};tu.BlurDirectionX=new H(1,0),tu.BlurDirectionY=new H(0,1);var nu={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
  ...
  `},au=class{composer;renderPass;bloomPass;constructor(e,t,n){this.composer=new Ql(e),this.renderPass=new $l(t,n),this.composer.addPass(this.renderPass),this.bloomPass=new tu(new H(window.innerWidth,window.innerHeight),.55,.5,.72),this.composer.addPass(this.bloomPass),this.composer.addPass(new Yl(iu)),this.composer.addPass(new ru)}setActive(e,t){this.renderPass.scene=e,this.renderPass.camera=t}setSize(e,t){this.composer.setSize(e,t),this.bloomPass.setSize(e,t)}render(){this.composer.render()}},ou=class{renderer;clock=new yo;current=null;rafId=0;paused=!1;postFx;constructor(e){this.renderer=new Ll({antialias:!0,powerPreference:`high-performance`}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=2,this.renderer.outputColorSpace=ze,this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1.05,e.appendChild(this.renderer.domElement),Hl(this.renderer),Rl.init(this.renderer.domElement),this.postFx=new au(this.renderer,new Nn,new Ua),window.addEventListener(`resize`,()=>this.handleResize())}async setScene(e){this.current&&=(this.current.dispose(),null);let t=await e();await t.init(),this.current=t,this.postFx.setActive(t.scene,t.camera),this.handleResize()}handleResize(){let e=window.innerWidth,t=window.innerHeight;this.renderer.setSize(e,t),this.postFx.setSize(e,t),this.current&&(this.current.camera.aspect=e/t,this.current.camera.updateProjectionMatrix(),this.current.onResize?.(e,t))}setPaused(e){this.paused=e}getCurrentScene(){return this.current}start(){let e=()=>{this.rafId=requestAnimationFrame(e);let t=Math.min(this.clock.getDelta(),.1),n=this.clock.getElapsedTime();!this.paused&&this.current&&(this.current.update(t,n),this.postFx.render()),Rl.endFrame()};this.rafId=requestAnimationFrame(e)}stop(){cancelAnimationFrame(this.rafId)}},Z=new class{listeners=new Map;on(e,t){return this.listeners.has(e)||this.listeners.set(e,new Set),this.listeners.get(e).add(t),()=>this.off(e,t)}off(e,t){this.listeners.get(e)?.delete(t)}emit(e,t){let n=this.listeners.get(e);if(n)for(let e of[...n])e(t)}};function su(){return{navigation:{label:`Navigation Array`,damaged:!0,repaired:!1,progress:0,requiredResource:`resonant_crystal`,requiredAmount:3,haveAmount:0},communications:{label:`Long-Range Comms`,damaged:!0,repaired:!1,progress:0,requiredResource:`conduit_alloy`,requiredAmount:2,haveAmount:0},hyperdrive:{label:`Hyperdrive Core`,damaged:!0,repaired:!1,progress:0,requiredResource:`stellar_core_shard`,requiredAmount:1,haveAmount:0},shields:{label:`Deflector Shields`,damaged:!0,repaired:!1,progress:0,requiredResource:`conduit_alloy`,requiredAmount:3,haveAmount:0},lifeSupport:{label:`Life Support`,damaged:!1,repaired:!0,progress:100,requiredResource:null,requiredAmount:0,haveAmount:0},scanner:{label:`Deep Scanner`,damaged:!0,repaired:!1,progress:0,requiredResource:`resonant_crystal`,requiredAmount:1,haveAmount:0},powerDistribution:{label:`Power Distribution`,damaged:!0,repaired:!1,progress:40,requiredResource:`conduit_alloy`,requiredAmount:1,haveAmount:0}}}function cu(){return{insight:1,archaeology:1,engineering:1,traversal:1,persuasion:1,perception:1}}var Q=new class{data={scene:`ship_interior`,flags:[],attributes:cu(),xp:0,level:1,unspentPoints:0,shipSystems:su(),inventory:[],journalLogs:[],clues:[],clueConnections:[],objective:`Systems rebooting...`,planetsUnlocked:[],playerPosition:null};hasFlag(e){return this.data.flags.includes(e)}setFlag(e){this.hasFlag(e)||(this.data.flags.push(e),Z.emit(`flag:set`,e))}setObjective(e){this.data.objective=e,Z.emit(`objective:changed`,e)}addAttributeXp(e,t){this.data.attributes[e]+=t,Z.emit(`attribute:changed`,{key:e,value:this.data.attributes[e]}),this.gainXp(t*10)}gainXp(e){this.data.xp+=e;let t=this.data.level*100;this.data.xp>=t&&(this.data.xp-=t,this.data.level+=1,this.data.unspentPoints+=1,Z.emit(`level:up`,this.data.level)),Z.emit(`xp:changed`,this.data.xp)}addClue(e){this.data.clues.find(t=>t.id===e.id)||(this.data.clues.push(e),Z.emit(`clue:added`,e))}connectClues(e,t,n){this.data.clueConnections.push({a:e,b:t,insight:n}),Z.emit(`clue:connected`,{a:e,b:t,insight:n})}unlockLog(e){let t=this.data.journalLogs.find(t=>t.id===e);t&&(t.unlocked=!0,Z.emit(`log:unlocked`,t))}addResource(e,t){for(let n of Object.keys(this.data.shipSystems)){let r=this.data.shipSystems[n];r.requiredResource===e&&(r.haveAmount=Math.min(r.requiredAmount,r.haveAmount+t))}Z.emit(`resource:added`,{resource:e,amount:t})}canRepair(e){let t=this.data.shipSystems[e];return t.damaged&&!t.repaired&&t.haveAmount>=t.requiredAmount}repairSystem(e){if(!this.canRepair(e))return!1;let t=this.data.shipSystems[e];return t.repaired=!0,t.damaged=!1,t.progress=100,t.haveAmount=0,Z.emit(`ship:repaired`,e),!0}toJSON(){return JSON.stringify(this.data)}loadFrom(e){let t=JSON.parse(e);this.data=t,Z.emit(`state:loaded`,this.data)}};function lu(e,t,n){let r=document.createElement(e);return t&&(r.className=t),n!==void 0&&(r.innerHTML=n),r}var uu=class{root=lu(`div`);crosshair=lu(`div`,`crosshair`);interactPrompt=lu(`div`,`interact-prompt`);objectiveTracker=lu(`div`);statusBar=lu(`div`);toastStack=lu(`div`);captionEl=lu(`div`,`cinematic-caption`);letterboxTop=lu(`div`,`letterbox-bar top`);letterboxBottom=lu(`div`,`letterbox-bar bottom`);fadeEl=lu(`div`,`fade-black`);init(){this.root.id=`ui-root`,this.crosshair.id=`crosshair`,this.interactPrompt.id=`interact-prompt`,this.objectiveTracker.id=`objective-tracker`,this.statusBar.id=`status-bar`,this.toastStack.id=`toast-stack`,this.captionEl.id=`cinematic-caption`,this.fadeEl.classList.add(`fade-black`),this.objectiveTracker.innerHTML=`<div class="label">Objective</div><div id="objective-text"></div>`,document.body.appendChild(this.root),this.root.appendChild(this.crosshair),this.root.appendChild(this.interactPrompt),this.root.appendChild(this.objectiveTracker),this.root.appendChild(this.statusBar),this.root.appendChild(this.toastStack),this.root.appendChild(this.captionEl),this.root.appendChild(this.letterboxTop),this.root.appendChild(this.letterboxBottom),document.body.appendChild(this.fadeEl),this.toastStack.classList.add(`interactive`),this.toastStack.style.pointerEvents=`none`,Z.on(`objective:changed`,e=>this.setObjective(e)),Z.on(`level:up`,()=>this.refreshStatusBar()),Z.on(`attribute:changed`,()=>this.refreshStatusBar()),this.setObjective(Q.data.objective),this.refreshStatusBar()}refreshStatusBar(){this.statusBar.innerHTML=`<span class="badge">LV ${Q.data.level}</span><span class="badge">TAB — Character</span>`}setObjective(e){let t=document.getElementById(`objective-text`);t&&(t.textContent=e)}setPrompt(e){e?(this.interactPrompt.innerHTML=`<kbd>E</kbd>${e}`,this.interactPrompt.classList.add(`visible`),this.crosshair.classList.add(`active`)):(this.interactPrompt.classList.remove(`visible`),this.crosshair.classList.remove(`active`))}toast(e){let t=lu(`div`,`toast`,e);this.toastStack.appendChild(t),setTimeout(()=>t.remove(),3200)}showLetterbox(e){this.letterboxTop.classList.toggle(`visible`,e),this.letterboxBottom.classList.toggle(`visible`,e)}setCrosshairVisible(e){this.crosshair.classList.toggle(`hidden`,!e)}showCaption(e,t=3200){this.captionEl.textContent=e,this.captionEl.classList.add(`visible`),window.clearTimeout(this.captionEl._t),this.captionEl._t=window.setTimeout(()=>this.captionEl.classList.remove(`visible`),t)}clearCaption(){this.captionEl.classList.remove(`visible`)}async fadeToBlack(){this.fadeEl.classList.add(`visible`),await du(1200)}async fadeFromBlack(){await du(50),this.fadeEl.classList.remove(`visible`),await du(1200)}skillCheckPopup(e,t){let n=lu(`div`,`skill-check-result`,e);n.style.left=`50%`,n.style.top=`68%`,n.style.transform=`translate(-50%, 0)`,n.style.color=t?`#7cbf7c`:`#c98a6a`,this.root.appendChild(n),n.style.transition=`opacity 1.5s ease, transform 1.5s ease`,requestAnimationFrame(()=>{n.style.opacity=`0`,n.style.transform=`translate(-50%, -30px)`}),setTimeout(()=>n.remove(),1600)}};function du(e){return new Promise(t=>setTimeout(t,e))}var $=new uu,fu=new class{overlay;content;openCallback=null;isOpen=!1;onOpenChange=()=>{};constructor(){this.overlay=document.createElement(`div`),this.overlay.className=`panel-overlay interactive`,this.content=document.createElement(`div`),this.overlay.appendChild(this.content),document.addEventListener(`keydown`,e=>{e.code===`Escape`&&this.isOpen&&this.close()})}mount(){document.getElementById(`ui-root`).appendChild(this.overlay)}open(e,t){this.content.innerHTML=``,this.content.appendChild(e),this.overlay.classList.add(`visible`),this.isOpen=!0,this.openCallback=t??null,Rl.exitPointerLock(),this.onOpenChange(!0)}close(){this.isOpen&&(this.overlay.classList.remove(`visible`),this.isOpen=!1,this.onOpenChange(!1),this.openCallback?.(),this.openCallback=null,this.content.innerHTML=``)}},pu=1.7,mu=3.2,hu=5.6,gu=1.6,_u=.35,vu=-18,yu=6,bu=.0022,xu=.45,Su=class{rig=new Cn;camera;velocityY=0;onGround=!1;yaw=0;pitch=0;colliders=[];floorTargets=[];enabled=!0;crouching=!1;raycaster=new go;moveState={speed:0};headBobTime=0;cameraShakeTrauma=0;onFootstep=null;lastBobHalfCycle=0;constructor(e,t=new U(0,1.7,0)){this.camera=e,this.rig.position.copy(t),this.rig.add(e),e.position.set(0,0,0)}setColliders(e){this.colliders=e.map(e=>({box:e}))}setFloorTargets(e){this.floorTargets=e}teleport(e,t=0){this.rig.position.copy(e),this.yaw=t,this.pitch=0,this.velocityY=0}resolveCollisionXZ(e){let t=e.clone(),n=e=>{for(let{box:t}of this.colliders)if(new U(Et.clamp(e.x,t.min.x,t.max.x),Et.clamp(e.y,t.min.y,t.max.y),Et.clamp(e.z,t.min.z,t.max.z)).distanceTo(e)<_u&&e.y>t.min.y-.1&&e.y<t.max.y+2)return!0;return!1},r=this.rig.position.clone();r.x=t.x,n(r)&&(t.x=this.rig.position.x);let i=this.rig.position.clone();return i.z=t.z,n(i)&&(t.z=this.rig.position.z),t}sampleFloorHeight(e,t){this.raycaster.set(new U(e,this.rig.position.y+2,t),new U(0,-1,0)),this.raycaster.far=10;let n=this.raycaster.intersectObjects(this.floorTargets,!0);return n.length===0?null:n[0].point.y}update(e){if(!this.enabled)return;let t=Rl.consumeMouseDelta();this.yaw-=t.x*bu,this.pitch-=t.y*bu,this.pitch=Et.clamp(this.pitch,-Math.PI/2+.05,Math.PI/2-.05),this.rig.rotation.set(0,this.yaw,0),this.camera.rotation.set(this.pitch,0,0),this.crouching=Rl.isDown(`ControlLeft`)||Rl.isDown(`KeyC`);let n=Rl.isDown(`ShiftLeft`)&&!this.crouching,r=this.crouching?gu:n?hu:mu,i=0,a=0;(Rl.isDown(`KeyW`)||Rl.isDown(`ArrowUp`))&&--a,(Rl.isDown(`KeyS`)||Rl.isDown(`ArrowDown`))&&(a+=1),(Rl.isDown(`KeyA`)||Rl.isDown(`ArrowLeft`))&&--i,(Rl.isDown(`KeyD`)||Rl.isDown(`ArrowRight`))&&(i+=1);let o=i!==0||a!==0;this.moveState.speed=o?r:0;let s=new U(0,0,-1).applyAxisAngle(new U(0,1,0),this.yaw),c=new U(1,0,0).applyAxisAngle(new U(0,1,0),this.yaw),l=new U;l.addScaledVector(s,-a),l.addScaledVector(c,i),l.lengthSq()>0&&l.normalize();let u=this.rig.position.clone().addScaledVector(l,r*e),d=this.resolveCollisionXZ(u),f=this.sampleFloorHeight(d.x,d.z);if(f!==null){let e=f-this.rig.position.y;e>xu&&!this.onGround||(Math.abs(e)<=1.45||this.velocityY<=0)&&(this.rig.position.y<=f+.05||e<=xu)&&(d.y=f,this.onGround=this.rig.position.y-f<.15||e>=-.2)}if(Rl.wasJustPressed(`Space`)&&this.onGround&&(this.velocityY=yu,this.onGround=!1),!this.onGround||f===null?(this.velocityY+=vu*e,d.y=this.rig.position.y+this.velocityY*e,f!==null&&d.y<=f&&(d.y=f,this.velocityY=0,this.onGround=!0)):this.velocityY=0,this.rig.position.copy(d),o&&this.onGround){this.headBobTime+=e*r*3.2;let t=Math.floor(this.headBobTime/Math.PI);t!==this.lastBobHalfCycle&&(this.lastBobHalfCycle=t,this.onFootstep?.())}let p=o&&this.onGround?Math.sin(this.headBobTime)*.035:0,m=o&&this.onGround?Math.cos(this.headBobTime*.5)*.02:0,h=new U;if(this.cameraShakeTrauma>0){let t=this.cameraShakeTrauma*this.cameraShakeTrauma;h=new U((Math.random()-.5)*t*.3,(Math.random()-.5)*t*.3,0),this.cameraShakeTrauma=Math.max(0,this.cameraShakeTrauma-e*1.6)}this.camera.position.set(m+h.x,pu+p+h.y-pu*(this.crouching?.35:0),h.z)}addShake(e){this.cameraShakeTrauma=Math.min(1,this.cameraShakeTrauma+e)}getWorldPosition(){let e=new U;return this.camera.getWorldPosition(e),e}getLookDirection(){let e=new U;return this.camera.getWorldDirection(e),e}};function Cu(e,t){let n=e.parent;for(;n;){if(n===t)return!0;n=n.parent}return!1}function wu(e){return typeof e.label==`function`?e.label():e.label}var Tu=class{interactables=[];raycaster=new go;currentTarget=null;currentLabel=null;onPromptChange=()=>{};register(e){return this.interactables.push(e),()=>{this.interactables=this.interactables.filter(t=>t!==e)}}clear(){this.interactables=[],this.currentTarget=null}update(e){this.raycaster.setFromCamera(new H(0,0),e);let t=new U;e.getWorldPosition(t);let n=this.interactables.filter(e=>!(e.enabled&&!e.enabled())),r=this.raycaster.intersectObjects(n.map(e=>e.object),!0),i=null;if(r.length>0){let e=r[0];i=n.find(t=>t.object===e.object||Cu(e.object,t.object))??null,i&&e.distance>i.range&&(i=null)}if(!i){let e=1/0;for(let r of n){let n=new U;r.object.getWorldPosition(n);let a=t.distanceTo(n);a>r.range||a<e&&(e=a,i=r)}}let a=i?wu(i):null;(i!==this.currentTarget||a!==this.currentLabel)&&(this.currentTarget=i,this.currentLabel=a,this.onPromptChange(a)),this.currentTarget&&Rl.wasJustPressed(`KeyE`)&&this.currentTarget.onInteract()}},Eu=null,Du=null,Ou=!1;function ku(){if(!Eu){let e=window.AudioContext||window.webkitAudioContext;if(!e)return null;Eu=new e,Du=Eu.createGain(),Du.gain.value=.5,Du.connect(Eu.destination)}return Eu}function Au(){if(Ou)return;let e=ku();e&&e.state===`suspended`&&e.resume().catch(()=>{}),Ou=!0}var ju={init(){window.addEventListener(`pointerdown`,Au,{once:!0}),window.addEventListener(`keydown`,Au,{once:!0})},setMasterVolume(e){Du&&(Du.gain.value=e)},playTone(e,t,n=`sine`,r=.15){let i=ku();if(!i||!Du)return;let a=i.createOscillator(),o=i.createGain();a.type=n,a.frequency.value=e,o.gain.setValueAtTime(0,i.currentTime),o.gain.linearRampToValueAtTime(r,i.currentTime+.02),o.gain.exponentialRampToValueAtTime(.001,i.currentTime+t),a.connect(o),o.connect(Du),a.start(),a.stop(i.currentTime+t+.05)},playChime(){this.playTone(523.25,.22,`sine`,.18),setTimeout(()=>this.playTone(659.25,.22,`sine`,.16),90),setTimeout(()=>this.playTone(783.99,.32,`sine`,.16),180)},playError(){this.playTone(220,.18,`sawtooth`,.09),setTimeout(()=>this.playTone(174.6,.22,`sawtooth`,.08),90)},playUiClick(){this.playTone(880,.05,`square`,.05)},playFootstep(e=`metal`){let t=ku();if(!t||!Du)return;let n=t.sampleRate*.05,r=t.createBuffer(1,n,t.sampleRate),i=r.getChannelData(0);for(let e=0;e<n;e++)i[e]=(Math.random()*2-1)*(1-e/n);let a=t.createBufferSource();a.buffer=r;let o=t.createBiquadFilter();o.type=e===`metal`?`highpass`:`lowpass`,o.frequency.value=e===`metal`?900:400;let s=t.createGain();s.gain.value=.06,a.connect(o),o.connect(s),s.connect(Du),a.start()},startAmbient(e,t=.05){let n=ku();if(!n||!Du)return()=>{};let r=n.createOscillator(),i=n.createOscillator(),a=n.createGain();r.type=`sine`,i.type=`sine`,r.frequency.value=e,i.frequency.value=e*1.01,a.gain.setValueAtTime(0,n.currentTime),a.gain.linearRampToValueAtTime(t,n.currentTime+2),r.connect(a),i.connect(a),a.connect(Du),r.start(),i.start();let o=!1;return()=>{if(o)return;o=!0;let e=n.currentTime;a.gain.linearRampToValueAtTime(0,e+1),r.stop(e+1.1),i.stop(e+1.1)}}},Mu=9,Nu=12,Pu=4,Fu=class{scene=new Nn;camera=new Ua(62,window.innerWidth/window.innerHeight,.05,500);player;interaction=new Tu;floorMeshes=[];consoleGlow=[];starfield=null;unsubShake=null;stopAmbient=null;constructor(){this.player=new Su(this.camera,new U(0,1.7,4))}async init(){this.scene.background=new K(197642),this.scene.environment=Ul(),this.scene.environmentIntensity=.6,this.buildRoom(),this.buildStarfieldWindow(),this.buildConsole(),this.buildDetailProps(),this.buildLighting(),this.scene.add(this.player.rig),this.player.setFloorTargets(this.floorMeshes),this.player.setColliders(this.roomColliders()),this.player.teleport(new U(0,1.7,4),0),this.player.onFootstep=()=>ju.playFootstep(`metal`),this.stopAmbient=ju.startAmbient(64,.035),this.interaction.onPromptChange=e=>$.setPrompt(e),this.unsubShake=Z.on(`player:shake`,e=>this.player.addShake(e)),Z.emit(`scene:ship_interior:ready`)}buildRoom(){let e=new J({color:2764344,roughness:.55,metalness:.25,side:2}),t=new J({color:3553862,roughness:.7,metalness:.15,side:2}),n=new J({color:1579810,roughness:.4,metalness:.5,side:2}),r=new q(new qi(Mu,.2,Nu),e);r.position.y=-.1,r.receiveShadow=!0,this.scene.add(r),this.floorMeshes.push(r);let i=new q(new qi(Mu,.15,Nu),n);i.position.y=Pu,this.scene.add(i);let a=new q(new qi(Mu,Pu,.2),t);a.position.set(0,Pu/2,Nu/2),a.receiveShadow=!0,this.scene.add(a);let o=new qi(.2,Pu,Nu),s=new q(o,t);s.position.set(-9/2,Pu/2,0),this.scene.add(s);let c=new q(o,t);c.position.set(Mu/2,Pu/2,0),this.scene.add(c);for(let e=-5;e<=5;e++){let t=new q(new qi(8.6,.02,.08),n);t.position.set(0,.01,e*1.05),this.scene.add(t)}}buildStarfieldWindow(){let e=new q(new qi(6.4,2.6,.15),new J({color:790035,metalness:.85,roughness:.3}));e.position.set(0,2.2,-5.7),this.scene.add(e);let t=new q(new ea(6,2.2),new ri({color:0,transparent:!0,opacity:0}));t.position.set(0,2.2,-5.62),this.scene.add(t);let n=2200,r=new Float32Array(n*3);for(let e=0;e<n;e++)r[e*3]=(Math.random()-.5)*400,r[e*3+1]=(Math.random()-.5)*200+40,r[e*3+2]=-26-Math.random()*300;let i=new Dr;i.setAttribute(`position`,new fr(r,3));let a=new Fi({color:16777215,size:.6,sizeAttenuation:!0});this.starfield=new Bi(i,a),this.scene.add(this.starfield);let o=new q(new ea(300,150),new ri({color:2767467,transparent:!0,opacity:.15}));o.position.set(-40,30,-200),o.rotation.z=.3,this.scene.add(o)}buildConsole(){let e=new J({color:2830136,roughness:.4,metalness:.7}),t=new J({color:1727610,emissive:1727610,emissiveIntensity:1.4,roughness:.3}),n=new q(new qi(2.6,1.1,.7),e);n.position.set(0,.55,-3.6),n.castShadow=!0,this.scene.add(n);let r=new q(new qi(2.2,.5,.05),t);r.position.set(0,1.15,-3.55),r.rotation.x=-.35,this.scene.add(r);let i=new Ga(3121110,2.2,4);i.position.set(0,1.2,-3.4),this.scene.add(i),this.consoleGlow.push(i);let a=new q(new Yi(.4,.45,.9,12),new J({color:3812386,roughness:.8}));a.position.set(0,.45,-1.6),this.scene.add(a),n.userData.interactable=!0,this.interaction.register({object:n,label:()=>Q.hasFlag(`galaxy_revealed`)?`Open Galaxy Map`:`Access Navigation Console`,range:2.2,onInteract:()=>{Q.hasFlag(`galaxy_revealed`)?Z.emit(`ui:open_galaxy_map`):$.toast(`Navigation offline — awaiting system reboot.`)}});let o=new q(new qi(.6,.9,.12),new J({color:2371642,emissive:2575162,emissiveIntensity:.6}));o.position.set(-4.35,1.3,1.5),o.rotation.y=Math.PI/2,this.scene.add(o),this.interaction.register({object:o,label:`Open Travel Logs`,range:2,enabled:()=>Q.hasFlag(`logs_available`),onInteract:()=>Z.emit(`ui:open_journal`)});let s=new q(new qi(.7,1.4,.5),new J({color:3811876,emissive:11162914,emissiveIntensity:.35}));s.position.set(Mu/2-.5,.7,2.2),this.scene.add(s),this.interaction.register({object:s,label:`Open Ship Repair Interface`,range:2,enabled:()=>Q.hasFlag(`damage_assessed`),onInteract:()=>Z.emit(`ui:open_repair`)})}buildDetailProps(){let e=[14241615,14263361,5233034,5214169],t=e=>new J({color:e,emissive:e,emissiveIntensity:.9,roughness:.3,metalness:.2});for(let n=0;n<2;n++)for(let r=0;r<5;r++){let i=new q(new Yi(.045,.045,.03,10),t(e[(n*5+r)%e.length]));i.rotation.x=Math.PI/2-.35,i.position.set(-.9+r*.42,.82+n*.14,-3.42-n*.08),this.scene.add(i)}let n=new J({color:1316380,roughness:.6,metalness:.4});for(let e=0;e<4;e++){let t=new q(new Yi(.03,.03,1.6,6),n);t.position.set(-4.25,2.6,-3+e*1.3),t.rotation.z=.08*(e%2==0?1:-1),this.scene.add(t)}let r=new J({color:2896188,roughness:.45,metalness:.5}),i=new q(new qi(.08,1.6,2.4),r);i.position.set(-4.34,1.4,-1),this.scene.add(i);for(let e=0;e<6;e++){let t=e%3==0?14241615:5233034,n=new q(new na(.03,8,8),new J({color:t,emissive:t,emissiveIntensity:1.6}));n.position.set(-4.29,.8+e*.28,-1.9+e%2*.4),this.scene.add(n)}let a=new J({color:1842982,roughness:.5,metalness:.6});for(let e of[-2.5,2.5]){let t=new q(new Yi(.08,.08,11,8),a);t.rotation.x=Math.PI/2,t.position.set(e,3.85,0),this.scene.add(t)}}buildLighting(){let e=new Ya(11453408,1);this.scene.add(e);let t=new Ja(13623551,1.6);t.position.set(3,5,3),this.scene.add(t);let n=new Ga(14674175,3.5,9,1.6);n.position.set(0,3.7,-2),this.scene.add(n);let r=new Ga(14674175,3,9,1.6);r.position.set(0,3.7,3),this.scene.add(r);let i=new Ga(16733491,1.5,8);i.position.set(-3,3.5,-2),this.scene.add(i)}roomColliders(){return[new Jn(new U(-9/2,0,Nu/2-.5),new U(Mu/2,3,Nu/2)),new Jn(new U(-9/2-1,0,-6),new U(-4.1,3,Nu/2)),new Jn(new U(Mu/2-.4,0,-6),new U(5.5,3,Nu/2)),new Jn(new U(-1.3,0,-3.9),new U(1.3,1.2,-3.2))]}update(e,t){this.player.update(e),this.interaction.update(this.camera);for(let e of this.consoleGlow)e.intensity=2+Math.sin(t*2.2)*.3;this.starfield&&(this.starfield.rotation.y+=e*.0015)}onResize(e,t){this.camera.aspect=e/t,this.camera.updateProjectionMatrix()}dispose(){this.unsubShake?.(),this.stopAmbient?.(),this.interaction.clear(),this.scene.traverse(e=>{let t=e;t.geometry&&t.geometry.dispose()})}},Iu=e=>e<.5?4*e*e*e:1-(-2*e+2)**3/2,Lu=class{camera;keyframes=[];index=0;t=0;holdT=0;playing=!1;onComplete=()=>{};startPos=new U;startLook=new U;startFov=50;constructor(e){this.camera=e}play(e,t){this.keyframes=e,this.index=0,this.t=0,this.holdT=0,this.playing=e.length>0,t&&(this.onComplete=t),this.captureStart()}captureStart(){this.startPos.copy(this.camera.position),this.startFov=this.camera.fov;let e=new U;this.camera.getWorldDirection(e),this.startLook.copy(this.camera.position).add(e)}skip(){if(!this.playing)return;let e=this.keyframes[this.keyframes.length-1];e&&(this.camera.position.copy(e.position),this.camera.lookAt(e.lookAt),e.fov&&(this.camera.fov=e.fov,this.camera.updateProjectionMatrix())),this.playing=!1,this.onComplete()}update(e){if(!this.playing)return;let t=this.keyframes[this.index];if(!t){this.playing=!1,this.onComplete();return}if(this.t<t.duration){this.t+=e;let n=Math.min(1,this.t/t.duration),r=(t.ease??Iu)(n);this.camera.position.lerpVectors(this.startPos,t.position,r);let i=new U().lerpVectors(this.startLook,t.lookAt,r);this.camera.lookAt(i),t.fov&&(this.camera.fov=Et.lerp(this.startFov,t.fov,r),this.camera.updateProjectionMatrix())}else this.holdT<(t.hold??0)?this.holdT+=e:(this.index+=1,this.t=0,this.holdT=0,this.startPos.copy(t.position),this.startLook.copy(t.lookAt),this.startFov=t.fov??this.startFov)}},Ru=[{id:`kethra`,name:`Kethra`,tagline:`Terraced ruins beneath a bioluminescent canopy.`,color:5214058,radius:5.2,orbitRadius:60,orbitAngle:.6,hasRing:!1,mapX:30,mapY:55},{id:`vessek`,name:`Vessek Anchorage`,tagline:`A shattered ring-station civilization clinging to the void.`,color:9075632,radius:4.2,orbitRadius:95,orbitAngle:2.1,hasRing:!0,mapX:55,mapY:30},{id:`orrun`,name:`Orrun's Reach`,tagline:`A storm-wracked desert world of buried machinery.`,color:11563071,radius:6,orbitRadius:130,orbitAngle:4,hasRing:!1,mapX:72,mapY:60},{id:`isilthe`,name:`Isilthe`,tagline:`An ocean moon where an ancient signal still sings.`,color:4161456,radius:4.8,orbitRadius:165,orbitAngle:5.3,hasRing:!0,mapX:48,mapY:78}];function zu(){let e=document.createElement(`canvas`);e.width=256,e.height=256;let t=e.getContext(`2d`),n=t.createRadialGradient(128,128,0,128,128,128);n.addColorStop(0,`rgba(255,235,190,0.9)`),n.addColorStop(.35,`rgba(255,219,153,0.45)`),n.addColorStop(1,`rgba(255,219,153,0)`),t.fillStyle=n,t.fillRect(0,0,256,256);let r=new Ui(e);return r.colorSpace=ze,r}function Bu(e,t,n){let r=new Float32Array(e*3),i=new Float32Array(e*3),a=new K;for(let n=0;n<e;n++){r[n*3]=(Math.random()-.5)*t,r[n*3+1]=(Math.random()-.5)*t,r[n*3+2]=(Math.random()-.5)*t;let e=Math.random();a.setHSL(e>.8?.08:e<.15?.6:.12,.25,.75+Math.random()*.25),i[n*3]=a.r,i[n*3+1]=a.g,i[n*3+2]=a.b}let o=new Dr;return o.setAttribute(`position`,new fr(r,3)),o.setAttribute(`color`,new fr(i,3)),new Bi(o,new Fi({vertexColors:!0,size:n,sizeAttenuation:!0}))}function Vu(e,t,n,r){let i=new Float32Array(e*3);for(let a=0;a<e;a++){let e=Math.random()*Math.PI*2,o=Et.lerp(t,n,Math.random());i[a*3]=Math.cos(e)*o,i[a*3+1]=(Math.random()-.5)*6,i[a*3+2]=r+Math.sin(e)*o}let a=new Dr;return a.setAttribute(`position`,new fr(i,3)),new Bi(a,new Fi({color:9077624,size:.5,sizeAttenuation:!0}))}function Hu(){let e=new wn,t=new J({color:9081246,metalness:.7,roughness:.35}),n=new J({color:14263361,emissive:14263361,emissiveIntensity:.6,metalness:.2,roughness:.4}),r=new q(new Ji(1.1,3.4,6,10),t);r.rotation.z=Math.PI/2,e.add(r);let i=new qi(3.2,.15,1.4),a=new q(i,t);a.position.set(-.3,0,1.6),e.add(a);let o=new q(i,t);o.position.set(-.3,0,-1.6),e.add(o);let s=new Yi(.35,.35,.3,12);for(let t of[-1,1]){let r=new q(s,n);r.rotation.x=Math.PI/2,r.position.set(-2.1,0,t*1.6),e.add(r)}let c=new q(new na(.55,16,12),n);return c.position.set(1.7,.3,0),e.add(c),e}var Uu=class{scene=new Nn;camera=new Ua(50,window.innerWidth/window.innerHeight,.1,4e3);sequencer;ship;sun;planetMeshes=[];elapsedTotal=0;readyForContinue=!1;onContinue=null;continueHandler=e=>{this.readyForContinue&&(e.code===`Enter`||e.code===`Space`)&&this.triggerContinue()};clickHandler=()=>{this.readyForContinue&&this.triggerContinue()};constructor(){this.sequencer=new Lu(this.camera),this.ship=Hu()}async init(){this.scene.background=new K(131850),this.scene.environment=Ul(),this.scene.environmentIntensity=.12,this.scene.add(Bu(2400,500,1.1)),this.scene.add(Bu(1800,900,.5)),this.scene.add(this.ship);let e=new Ya(4478327,.18);this.scene.add(e),this.sun=new q(new na(9,32,32),new ri({color:16767114})),this.sun.position.set(0,0,-140),this.scene.add(this.sun);let t=new Ga(16769963,5.5,500,1.4);t.position.copy(this.sun.position),this.scene.add(t);let n=new qr(new Nr({map:zu(),color:16777215,transparent:!0,depthWrite:!1,blending:2}));n.scale.set(46,46,1),n.position.copy(this.sun.position),this.scene.add(n);let r=new qr(new Nr({map:zu(),color:16758896,transparent:!0,opacity:.55,depthWrite:!1,blending:2}));r.scale.set(110,110,1),r.position.copy(this.sun.position),this.scene.add(r),this.scene.add(Vu(900,26,42,this.sun.position.z));for(let e of Ru){let t=new q(new na(e.radius,24,24),new J({color:e.color,roughness:.7,metalness:.15})),n=e.orbitAngle;if(t.position.set(Math.cos(n)*e.orbitRadius,Math.sin(n*.4)*8,this.sun.position.z+Math.sin(n)*e.orbitRadius),t.userData.planetId=e.id,this.scene.add(t),this.planetMeshes.push(t),e.hasRing){let n=new q(new ta(e.radius*1.5,e.radius*2.1,48),new ri({color:e.color,transparent:!0,opacity:.35,side:2}));n.rotation.x=Math.PI/2.4,n.position.copy(t.position),this.scene.add(n)}}this.camera.position.set(0,.6,6),this.camera.lookAt(this.ship.position.clone().add(new U(3,0,0))),window.addEventListener(`keydown`,this.continueHandler),window.addEventListener(`click`,this.clickHandler),this.playReveal()}playReveal(){$.showLetterbox(!0);let e=this.sun.position;this.sequencer.play([{position:new U(4,1.2,10),lookAt:this.ship.position.clone(),duration:3.2,hold:.4},{position:new U(24,14,42),lookAt:new U(-6,2,e.z*.4),duration:4.5,hold:.8,fov:55},{position:new U(38,48,158),lookAt:new U(12,-8,e.z*.58),duration:5.5,hold:2,fov:58}],()=>{this.readyForContinue=!0,$.showCaption(`Click or press Enter to continue`,999999)}),setTimeout(()=>$.showCaption(`You are stranded, alone, in a galaxy no chart has ever mapped.`,4200),1200),setTimeout(()=>$.showCaption(`Somewhere out there is the truth — and a way home.`,4200),8200)}triggerContinue(){this.readyForContinue&&(this.readyForContinue=!1,$.clearCaption(),$.showLetterbox(!1),this.onContinue?.())}update(e,t){this.elapsedTotal=t,this.sequencer.update(e);for(let t of this.planetMeshes)t.rotation.y+=e*.05;this.ship.rotation.y=Math.sin(this.elapsedTotal*.15)*.05}onResize(e,t){this.camera.aspect=e/t,this.camera.updateProjectionMatrix()}dispose(){window.removeEventListener(`keydown`,this.continueHandler),window.removeEventListener(`click`,this.clickHandler),$.showLetterbox(!1),$.clearCaption()}},Wu=[{type:`shields`,label:`Shields`,icon:`◈`,hint:`Brace against a direct hit.`},{type:`scanner`,label:`Scanner`,icon:`◎`,hint:`Read the weak point in their targeting array.`},{type:`evade`,label:`Thrusters`,icon:`▲`,hint:`Slip out of their firing arc.`}],Gu=3,Ku=1100,qu=class{container;round=0;pattern=[];inputIndex=0;phase=`idle`;timerSeconds=0;timerMax=1;rafHandle=0;lastT=0;active=!1;onWin=()=>{};constructor(){this.container=document.createElement(`div`)}start(){this.active=!0,this.round=0,$.showCaption(`INCOMING CONTACT — unknown vessel closing fast.`,3400),setTimeout(()=>this.beginRound(),2200)}beginRound(){if(!this.active)return;this.pattern=[];let e=this.round+1;for(let t=0;t<e;t++)this.pattern.push(Wu[Math.floor(Math.random()*Wu.length)].type);this.inputIndex=0,this.phase=`telegraph`,this.renderTelegraph(0)}renderTelegraph(e){if(!this.active)return;if(e>=this.pattern.length){this.phase=`input`,this.timerMax=5+this.pattern.length*3.2,this.timerSeconds=this.timerMax,this.lastT=performance.now(),this.render(),this.tick();return}let t=this.pattern[e],n=Wu.find(e=>e.type===t);this.renderTelegraphFrame(e,n.label),setTimeout(()=>this.renderTelegraph(e+1),Ku)}renderTelegraphFrame(e,t){this.container.innerHTML=``;let n=document.createElement(`div`);n.className=`panel`,n.id=`power-puzzle-panel`;let r=document.createElement(`h2`);r.textContent=`Round ${this.round+1} of ${Gu} — Reading Attack Vector`,n.appendChild(r);let i=document.createElement(`div`);i.id=`threat-indicator`,i.textContent=`Observe the sequence… (${e+1}/${this.pattern.length})`,n.appendChild(i);let a=document.createElement(`div`);a.style.cssText=`text-align:center; font-size:52px; color: var(--accent); margin: 30px 0; letter-spacing: 0.1em;`,a.textContent=t.toUpperCase(),n.appendChild(a),this.mount(n)}render(){this.container.innerHTML=``;let e=document.createElement(`div`);e.className=`panel`,e.id=`power-puzzle-panel`;let t=document.createElement(`h2`);t.textContent=`Round ${this.round+1} of ${Gu} — Redirect Power`,e.appendChild(t);let n=document.createElement(`div`);n.id=`threat-indicator`,n.textContent=`Repeat the sequence: ${this.inputIndex}/${this.pattern.length} correct`,e.appendChild(n);let r=document.createElement(`div`);r.id=`threat-timer-track`;let i=document.createElement(`div`);i.id=`threat-timer-fill`,i.style.width=`${this.timerSeconds/this.timerMax*100}%`,r.appendChild(i),e.appendChild(r);let a=document.createElement(`div`);a.id=`power-nodes`;for(let e of Wu){let t=document.createElement(`div`);t.className=`power-node`,t.innerHTML=`<div class="icon">${e.icon}</div><div class="name">${e.label}</div><div class="pips">${[0,1,2].map(()=>`<div class="pip filled"></div>`).join(``)}</div>`,t.onclick=()=>this.handleInput(e.type),a.appendChild(t)}e.appendChild(a);let o=document.createElement(`div`);o.className=`subtitle`,o.style.textAlign=`center`,o.textContent=Wu.find(e=>e.type===this.pattern[this.inputIndex])?.hint??``,e.appendChild(o),this.mount(e)}tick(){if(!this.active||this.phase!==`input`)return;let e=performance.now(),t=(e-this.lastT)/1e3;if(this.lastT=e,this.timerSeconds-=t,this.timerSeconds<=0){this.onMistake(`Sequence lost — recalibrating scanners.`);return}let n=document.getElementById(`threat-timer-fill`);n&&(n.style.width=`${Math.max(0,this.timerSeconds/this.timerMax*100)}%`),this.rafHandle=requestAnimationFrame(()=>this.tick())}handleInput(e){this.phase===`input`&&(e===this.pattern[this.inputIndex]?(this.inputIndex++,this.inputIndex>=this.pattern.length?this.onRoundSuccess():this.render()):this.onMistake(`Wrong system — the enemy adjusted its approach. Try again.`))}onMistake(e){cancelAnimationFrame(this.rafHandle),Z.emit(`player:shake`,.35),ju.playError(),$.toast(e),this.phase=`idle`,setTimeout(()=>this.beginRound(),900)}onRoundSuccess(){cancelAnimationFrame(this.rafHandle),this.phase=`success`,ju.playChime(),$.toast(`System redirect successful.`),Q.addAttributeXp(`engineering`,1),this.round++,this.round>=Gu?setTimeout(()=>this.finish(),1200):setTimeout(()=>this.beginRound(),1400)}finish(){this.active=!1,this.container.remove(),Q.setFlag(`tutorial_battle_complete`),this.onWin()}mount(e){this.container.innerHTML=``,this.container.appendChild(e),this.container.parentElement||(this.container.className=`panel-overlay visible interactive`,document.getElementById(`ui-root`).appendChild(this.container))}dispose(){this.active=!1,cancelAnimationFrame(this.rafHandle),this.container.remove()}},Ju=new class{tree=null;currentNodeId=``;onClose=null;isActive(){return this.tree!==null}start(e,t){this.tree=e,this.currentNodeId=e.startNode,this.onClose=t??null,this.render()}goto(e){if(!this.tree||e===null){this.end();return}this.currentNodeId=e,this.tree.nodes[e]?.onEnter?.(),this.render()}end(){this.tree=null,fu.close(),this.onClose?.(),this.onClose=null}render(){if(!this.tree)return;let e=this.tree.nodes[this.currentNodeId];if(!e){this.end();return}let t=document.createElement(`div`);t.className=`panel`,t.id=`dialogue-panel`;let n=document.createElement(`div`);n.id=`dialogue-speaker`,n.textContent=e.speaker,t.appendChild(n);let r=document.createElement(`div`);r.id=`dialogue-text`,r.textContent=e.text,t.appendChild(r);let i=document.createElement(`div`);i.id=`dialogue-options`;let a=e.options.length>0?e.options:[{text:`End conversation.`,next:null}];for(let e of a){let t=document.createElement(`button`);t.className=`dialogue-option`,e.requires&&Q.data.attributes[e.requires.attribute]<e.requires.min?(t.classList.add(`locked`),t.innerHTML=`<span class="tag">${e.requires.attribute} ${e.requires.min}+</span>${e.lockedHint??e.text}`):(e.requires?t.innerHTML=`<span class="tag">${e.requires.attribute}</span>${e.text}`:t.textContent=e.text,t.onclick=()=>{ju.playUiClick(),e.onChoose?.(),this.goto(e.next)}),i.appendChild(t)}t.appendChild(i),fu.open(t,()=>{this.tree=null})}};function Yu(){let e=[{text:`Tell me about these ruins.`,next:`warden_history`},{text:`Why is the canopy dimming?`,next:`warden_dimming`},{text:`What guards the inner chamber?`,next:`warden_guardian`},{text:`Convince me you're not like the others who came here.`,next:`warden_trust1`,requires:{attribute:`persuasion`,min:2},lockedHint:`You sense you have not earned this question yet.`,onChoose:()=>Q.setFlag(`kethra_warden_trust_1`)}];return Q.hasFlag(`kethra_helped_with_valve`)&&e.push({text:`I fixed the lower valve for your people. Does that count for anything?`,next:`warden_valve_thanks`,onChoose:()=>Q.setFlag(`kethra_warden_valve_thanks`)}),e.push({text:`That's all, for now.`,next:null}),e}var Xu={id:`kethra_warden`,startNode:`warden_greeting`,nodes:{warden_greeting:{id:`warden_greeting`,speaker:`Warden Corvenna`,text:`The bioluminescence along her arms draws inward as you approach, wary rather than welcoming. "Outsiders don't land on Kethra by accident. State your business, or turn back toward whatever wreck brought you here."`,options:[{text:`My ship is grounded. I need materials your ruins might spare.`,next:`warden_explain`},{text:`Say nothing. Let your silence speak for you.`,next:`warden_silent_listen`},{text:`Step back and leave her be.`,next:null}]},warden_explain:{id:`warden_explain`,speaker:`Warden Corvenna`,text:`Her glow pulses once — a considering color, not quite trust. "Spare. As if the Cistern Heart owes strangers anything. Others came before you with the same story, and left carrying more than they should have."`,options:[{text:`I only need what's already broken beyond your use.`,next:`warden_topics`},{text:`Then tell me plainly what I shouldn't touch.`,next:`warden_topics`}],onEnter:()=>Q.setFlag(`kethra_warden_met`)},warden_silent_listen:{id:`warden_silent_listen`,speaker:`Warden Corvenna`,text:`You say nothing. For a long moment, neither does she — the tree-city's hush filling the space between you. Then, softer: "...Most talk more than they should, this soon. Come. Ask what you need to ask."`,options:[{text:`Continue.`,next:`warden_topics`}],onEnter:()=>Q.setFlag(`kethra_warden_met`)},warden_topics:{id:`warden_topics`,speaker:`Warden Corvenna`,text:`She watches you the way one watches weather — waiting to see which way you'll turn.`,options:Yu(),onEnter:()=>{Xu.nodes.warden_topics.options=Yu()}},warden_history:{id:`warden_history`,speaker:`Warden Corvenna`,text:`"These boughs were not grown, they were built — by the Kindling, long before the Aiveth climbed this high. We inherited their city the way a bird inherits an empty nest: gratefully, and without understanding how it was woven." Her eyes flick to the glyphs ringing the terrace. "We do not read what they left. We only repeat what we were told it means."`,options:[{text:`Read the boundary glyphs yourself, instead of trusting what you were told.`,next:`warden_history_glyphs`,requires:{attribute:`archaeology`,min:3},lockedHint:`The glyphs mean nothing to you yet.`},{text:`Go back to other questions.`,next:`warden_topics`},{text:`That's all, for now.`,next:null}]},warden_history_glyphs:{id:`warden_history_glyphs`,speaker:`Warden Corvenna`,text:`You trace the boundary glyphs with your own eyes, and something in the phrasing snags. The ritual stanza carved here does not quite match the one the acolytes chant — a stroke simplified, a repetition dropped, the kind of drift that happens when a text is copied by ear instead of by eye for a hundred generations. Corvenna watches you notice it, and says nothing to deny it.`,options:[{text:`Go back to other questions.`,next:`warden_topics`},{text:`That's all, for now.`,next:null}],onEnter:()=>Q.addClue({id:`kethra_clue_glyph_altered`,title:`The Ritual Glyphs Don't Match the Ritual`,summary:`The carved boundary stanza differs subtly from the chant the Aiveth perform today — generations of oral drift, not deliberate change.`,source:`Warden Corvenna, Kethra`})},warden_dimming:{id:`warden_dimming`,speaker:`Warden Corvenna`,text:`"The Cistern Heart has fed light and water up through this whole city since before any of us were born. It has been dimming for three seasons now. We perform the Rite of Three Breaths exactly as it was given to us — and still, every season, it dims a little further." A pause. "You will not go near it. It is not a machine to you. It is sacred, and it is not yours to open."`,options:[{text:`Go back to other questions.`,next:`warden_topics`},{text:`That's all, for now.`,next:null}]},warden_guardian:{id:`warden_guardian`,speaker:`Warden Corvenna`,text:`"The Wickmoth keeps the inner chamber. It has always kept it — since before the Rite was ours to perform. It does not hunt. It does not forgive carelessness, either. Carry an open flame or a restless light near it, and it will treat you as a threat to what it guards." Her tone leaves no room for argument. "Go quietly, or don't go at all."`,options:[{text:`Go back to other questions.`,next:`warden_topics`},{text:`That's all, for now.`,next:null}]},warden_trust1:{id:`warden_trust1`,speaker:`Warden Corvenna`,text:`Something in her posture loosens, fractionally. "There were others, years back. Traders. They smiled the way you smile, asked the questions you're asking, and left with three cart-loads of grave goods and a promise to return that they never kept. So. You'll forgive me the wariness." She studies you a moment longer. "You may yet be different. I haven't decided."`,options:[{text:`Ask what would actually change her mind.`,next:`warden_trust2`,requires:{attribute:`persuasion`,min:4},lockedHint:`She isn't ready to say more than this, not to you — not yet.`,onChoose:()=>Q.setFlag(`kethra_warden_trust_2`)},{text:`Go back to other questions.`,next:`warden_topics`},{text:`Leave it there.`,next:null}],onEnter:()=>Q.addClue({id:`kethra_clue_outsiders_history`,title:`What the Last Outsiders Took`,summary:`Traders once won the Aiveth's trust and repaid it by stripping the ruins of grave goods. It explains the Warden's wariness.`,source:`Warden Corvenna, Kethra`})},warden_trust2:{id:`warden_trust2`,speaker:`Warden Corvenna`,text:`She lowers her voice, as if the terrace itself might be listening. "I will tell you what I tell no acolyte. I do not think the Rite works anymore — I do not think it has worked in my lifetime. I think something in it was lost long before it reached my hands. And I think the true shape of it is still out there, cut into stone the Kindling left behind, in pieces scattered too far apart for any one of us to read alone." She meets your eyes. "Find them, if you can. Do not tell the others where you heard that."`,options:[{text:`What happened to the Kindling, in the end?`,next:`warden_trust2_kindling`},{text:`Go back to other questions.`,next:`warden_topics`},{text:`Leave it there.`,next:null}],onEnter:()=>Q.addClue({id:`kethra_clue_warden_confession`,title:`The Warden's Doubt`,summary:`Corvenna privately believes the Rite of Three Breaths is broken and that the true sequence survives only in scattered Kindling inscriptions.`,source:`Warden Corvenna, Kethra`})},warden_trust2_kindling:{id:`warden_trust2_kindling`,speaker:`Warden Corvenna`,text:`"No one knows, truly. Our oldest stories say the sky over Kethra went white all at once — not a fire spreading, but every light in the world called home in the same breath. No siege. No war. Just... absence, after." She looks at you sidelong. "You have that same look some nights, when you think no one is watching your ship. Like you're waiting for the sky to do it again."`,options:[{text:`Go back to other questions.`,next:`warden_topics`},{text:`Leave it there.`,next:null}]},warden_valve_thanks:{id:`warden_valve_thanks`,speaker:`Warden Corvenna`,text:`For the first time, something like warmth reaches her glow. "That valve has wept rust since before I was warded. You didn't have to fix it, and you did." She inclines her head, a real concession. "Go to the inner terraces if you must. I won't stand in your way there. Just remember what I said about the Wickmoth — kindness to us won't soften it."`,options:[{text:`Go back to other questions.`,next:`warden_topics`},{text:`Thank you.`,next:null}]}}},Zu={id:`kethra_archivist`,startNode:`archivist_greeting`,nodes:{archivist_greeting:{id:`archivist_greeting`,speaker:`Fen Larkspur`,text:`A young Aiveth drops down from a low branch, landing light on bare feet, already grinning. "An outsider! Actually here, not just a rumor from the lower boughs. I'm Fen — I keep what records the Kindling left us. Ask me anything, I mean it. Corvenna's the one who'll make you work for answers, not me."`,options:[{text:`Who are you, really?`,next:`archivist_about`},{text:`Tell me about the Aiveth.`,next:`archivist_culture`},{text:`What's wrong with the canopy?`,next:`archivist_cistern`},{text:`I've heard something guards the inner chamber.`,next:`archivist_guardian`},{text:`Are there records of whoever built this place?`,next:`archivist_kindling`},{text:`These ruins remind me of something on my own ship. Do you feel that too?`,next:`archivist_insight_link`,requires:{attribute:`insight`,min:3},lockedHint:`You can't quite name what's nagging at you yet.`},{text:`I should go.`,next:null}]},archivist_about:{id:`archivist_about`,speaker:`Fen Larkspur`,text:`"Third-generation archive-keeper. My grove-mother kept the records before me, and hers before that." The grin fades a little. "Truth is, I took it up early. My little sibling, Oshel, is grove-bound — too young to climb to the brighter boughs — and the lower terraces have been getting dimmer every season. I want to understand this place well enough to fix what's actually broken, not just light more candles."`,options:[{text:`What happens if the canopy keeps failing?`,next:`archivist_stakes`},{text:`Go back to other questions.`,next:`archivist_greeting`},{text:`That's all, for now.`,next:null}]},archivist_stakes:{id:`archivist_stakes`,speaker:`Fen Larkspur`,text:`Fen's hands go still on the branch they're gripping. "The lower boughs go dark first. Oshel's grove is already the dimmest in the terrace — they've been sleeping through the daylight cycle because there isn't enough of it left to wake them properly." A breath. "I'm not telling you this so you'll pity us. I'm telling you because I need this fixed, and Corvenna would rather it stayed sacred and broken than working and understood."`,options:[{text:`Go back to other questions.`,next:`archivist_greeting`},{text:`I'll keep that in mind.`,next:null}]},archivist_culture:{id:`archivist_culture`,speaker:`Fen Larkspur`,text:`"We speak half in words and half in glow — you'll have noticed. A held color means something a spoken word can't. It's how we've always greeted, argued, mourned." They gesture at the terraces around you. "And once a season, the whole grove performs the Rite of Three Breaths together, to thank the Cistern Heart for the light it gives us. Except lately it doesn't seem to be listening."`,options:[{text:`Do you think you're performing it wrong?`,next:`archivist_ritual_wrong`},{text:`Go back to other questions.`,next:`archivist_greeting`},{text:`That's all, for now.`,next:null}]},archivist_ritual_wrong:{id:`archivist_ritual_wrong`,speaker:`Fen Larkspur`,text:`Fen glances over both shoulders before answering, low. "Don't repeat this to the elders. But yes — I think we are. A rite passed mouth to mouth for that many generations doesn't survive perfectly. Ours calls the colors in an order that just... doesn't feel right to me, and I can't prove it, and nobody wants to hear a records-keeper my age say the sacred thing might be a mistake."`,options:[{text:`Go back to other questions.`,next:`archivist_greeting`},{text:`That's all, for now.`,next:null}],onEnter:()=>Q.setFlag(`kethra_archivist_doubts_ritual`)},archivist_cistern:{id:`archivist_cistern`,speaker:`Fen Larkspur`,text:`"The Cistern Heart draws water up from the deep roots and turns it into light — that part everyone agrees on. What it needs to do that, the old carvings call 'three breaths': three colors, called in a fixed order, into the chamber at its center. Get the order right and the whole canopy should wake up bright again. Get it wrong, and..." They shrug at the dimming light around you. "Well. This."`,options:[{text:`How would I even learn the right order?`,next:`archivist_fragments`},{text:`Go back to other questions.`,next:`archivist_greeting`},{text:`That's all, for now.`,next:null}],onEnter:()=>Q.addClue({id:`kethra_clue_cistern_mechanism`,title:`The Rite of Three Breaths`,summary:`The Cistern Heart wakes when three colors of light are called into its inner chamber in the correct, fixed order.`,source:`Fen Larkspur, Kethra`})},archivist_fragments:{id:`archivist_fragments`,speaker:`Fen Larkspur`,text:`"There are inscription fragments scattered through the outer ruins — three that I know of. Each one describes a single breath of the Rite: what it looks like, and where it falls in the calling. Read as translations they're half-poetry, but the order is in there if you're patient." Fen taps their chin. "The trouble is reading them right. Kindling script wasn't written to be skimmed."`,options:[{text:`What should I watch for, reading Kindling script?`,next:`archivist_fragments_hint`,requires:{attribute:`archaeology`,min:3},lockedHint:`You don't yet know enough about Kindling script to ask a useful question here.`},{text:`Go back to other questions.`,next:`archivist_greeting`},{text:`That's all, for now.`,next:null}]},archivist_fragments_hint:{id:`archivist_fragments_hint`,speaker:`Fen Larkspur`,text:`Fen brightens, delighted someone asked. "Kindling stanzas number themselves by position in the breath, not by where they're physically carved — first, between, and last. Don't assume the fragment you find first in the ruins is the first breath of the Rite. Read what each one calls itself, not where you found it."`,options:[{text:`Go back to other questions.`,next:`archivist_greeting`},{text:`That's all, for now.`,next:null}],onEnter:()=>Q.addClue({id:`kethra_clue_fragment_hint`,title:`Reading the Fragments in Order`,summary:`Each inscription fragment names its own position in the Rite (first, between, last) — physical find order is not sequence order.`,source:`Fen Larkspur, Kethra`})},archivist_guardian:{id:`archivist_guardian`,speaker:`Fen Larkspur`,text:`"The Wickmoth. It's been in the inner chamber longer than the Aiveth have lived here — it isn't vicious, just possessive. Big, slow, wings like a stained-glass window with the light still moving through it." Fen's voice turns careful. "It reads light the way we read faces. Steady glow, it mostly ignores you. Sudden light, bright light, anything that flares or moves erratically — it reads that as a threat and it will come looking for the source."`,options:[{text:`Go back to other questions.`,next:`archivist_greeting`},{text:`That's all, for now.`,next:null}],onEnter:()=>Q.addClue({id:`kethra_clue_guardian_behavior`,title:`The Wickmoth's Temperament`,summary:`Territorial, not hostile. It ignores steady, dim light but investigates and confronts anything sudden or erratic.`,source:`Fen Larkspur, Kethra`})},archivist_kindling:{id:`archivist_kindling`,speaker:`Fen Larkspur`,text:`"The Kindling. That's our name for them — we don't actually know what they called themselves. They built the terraces, the Cistern Heart, all of it, and then they just... stopped. No war in the record. No plague. The last carvings before the record goes quiet all describe the same thing, over and over, in different hands: the sky turning white, all at once, everywhere. Then nothing more is carved, ever again."`,options:[{text:`Go back to other questions.`,next:`archivist_greeting`},{text:`That's all, for now.`,next:null}],onEnter:()=>Q.addClue({id:`kethra_clue_kindling_vanishing`,title:`The Kindling's Silence`,summary:`The precursor civilization's records end abruptly with repeated accounts of the sky turning white all at once, everywhere — then nothing.`,source:`Fen Larkspur, Kethra`})},archivist_insight_link:{id:`archivist_insight_link`,speaker:`Fen Larkspur`,text:`You describe it before you've fully decided to: the reveal over your ship's viewport, the sky doing something no sky should do, all at once. Fen goes very still. "That's... that's almost word for word how the last Kindling carvings describe it. I thought that was just how endings get written — a flourish. What if it isn't? What if something out there does that, and it isn't the first time?"`,options:[{text:`Go back to other questions.`,next:`archivist_greeting`},{text:`I don't know. But I want to find out.`,next:null}],onEnter:()=>{Q.addClue({id:`kethra_clue_ship_echo`,title:`A Familiar Sky`,summary:`The player's own account of their ship's disaster matches the Kindling's final carvings almost exactly.`,source:`Player observation, shared with Fen Larkspur`}),Q.connectClues(`kethra_clue_kindling_vanishing`,`kethra_clue_ship_echo`,`Whatever silenced the Kindling and whatever crippled my ship may be the same kind of event — or the same cause, centuries apart.`)}}}},Qu=[{id:`kethra_frag_first`,title:`Inscription Fragment — The First Breath`,body:`"...the Heart wakes first to the color of water remembered — not the rain that falls, but the water that waited in the dark beneath the roots, cold and old and blue as a sky that has never been seen. Call this hue ▓▓▓▓, before any other, or the Heart will not stir at ▓▓▓▓..."`,corrupted:!0,timestamp:`Kindling Era — Outer Terrace Fragment`,unlocked:!1},{id:`kethra_frag_between`,title:`Inscription Fragment — The Breath Between`,body:`"...this is not the first breath, and it is not the last — it is the one that answers the first. Where root-cold meets fire, call the color of coal woken from ash, of dawn caught in the moment before it clears the ▓▓▓▓. Call it second, between water and green, or the ▓▓▓▓ answers nothing..."`,corrupted:!0,timestamp:`Kindling Era — Lower Terrace Fragment`,unlocked:!1},{id:`kethra_frag_last`,title:`Inscription Fragment — The Final Breath`,body:`Remarkably intact for its age. "Last of the three, called only once water and ember have already answered: the color of new leaf unfurling, of the whole canopy breathing out at once. Call it last, and only last, and the Heart is whole again."`,corrupted:!1,timestamp:`Kindling Era — Inner Approach Fragment`,unlocked:!1},{id:`kethra_ritual_record`,title:`The Rite of Three Breaths, as Performed Today`,body:`A clean, well-kept grove record. "Each season the grove gathers at the terrace rail, and the acolytes raise their lanterns together. Blue is called first, to wake the roots. Green is called second, to answer the blue. Gold is called last, to close the Rite and send the color home." Passed down unchanged, or so every acolyte believes.`,corrupted:!1,timestamp:`Aiveth Fourth Generation, Current Practice`,unlocked:!1},{id:`kethra_kindling_record`,title:`Last Carving Before the Silence`,body:`"...and on the ▓▓▓▓ day the sky above every terrace turned white at once — not a fire spreading from one bough to the next, but every light in the world called home in the same breath, everywhere, together. There was no ▓▓▓▓ before it. There was no warning carved anywhere that we have found. [DATA INCOMPLETE — remaining stanzas illegible] ...if it comes again, let whoever reads this know it has happened ▓▓▓▓ before..."`,corrupted:!0,timestamp:`Kindling Era — Final Recorded Carving`,unlocked:!1}],$u=[`azure`,`amber`,`verdant`],ed=[`azure`,`verdant`,`amber`],td={azure:{label:`Azure`,hex:`#4f8fd9`},verdant:{label:`Verdant`,hex:`#4fd98a`},amber:{label:`Amber`,hex:`#d9a441`},crimson:{label:`Crimson`,hex:`#d9524f`},violet:{label:`Violet`,hex:`#a04fd9`}},nd=Array.from(new Set([...$u,`crimson`,`violet`])).slice(0,5),rd=class{inputIndex=0;onSolved=()=>{};open(){if(Q.hasFlag(`kethra_mechanism_solved`)){$.toast(`The Cistern Heart is already resonating steadily.`);return}if([`kethra_fragment_1_read`,`kethra_fragment_2_read`,`kethra_fragment_3_read`].filter(e=>Q.hasFlag(e)).length===0){$.toast(`The console is inert. Perhaps the old inscriptions around the terraces hold the sequence.`);return}this.inputIndex=0,this.render()}render(){let e=document.createElement(`div`);e.className=`panel`,e.id=`power-puzzle-panel`;let t=document.createElement(`h2`);t.textContent=`The Cistern Heart`,e.appendChild(t);let n=document.createElement(`div`);if(n.className=`subtitle`,n.textContent=`Set the resonance crystals to the sequence recorded in the old inscriptions.`,e.appendChild(n),this.inputIndex===0&&Q.data.attributes.perception>=3){let t=td[$u[0]]?.label??$u[0],n=document.createElement(`div`);n.className=`subtitle`,n.style.color=`var(--accent)`,n.textContent=`Your trained eye catches it first: the sequence begins with ${t}.`,e.appendChild(n)}let r=document.createElement(`div`);r.id=`threat-indicator`,r.textContent=`Sequence: ${this.inputIndex}/${$u.length} set`,e.appendChild(r);let i=document.createElement(`div`);i.id=`power-nodes`;for(let e of nd){let t=td[e]??{label:e,hex:`#888888`},n=document.createElement(`div`);n.className=`power-node`,n.innerHTML=`<div class="icon" style="color:${t.hex}">◈</div><div class="name">${t.label}</div>`,n.onclick=()=>this.handleInput(e),i.appendChild(n)}e.appendChild(i);let a=document.createElement(`div`);a.className=`close-hint`,a.textContent=`ESC to close`,e.appendChild(a),fu.open(e)}handleInput(e){if(e===$u[this.inputIndex])this.inputIndex++,this.inputIndex>=$u.length?this.solve():this.render();else{ju.playError();let t=this.inputIndex;e===ed[this.inputIndex]?$.toast(t>0?`${t} resonance${t===1?``:`s`} held — but this is the Rite as the Aiveth still perform it, and it has never once worked.`:`That matches the Rite the Aiveth still perform — and it has never once worked.`):t>0?$.toast(`${t} resonance${t===1?``:`s`} held before this one broke the pattern.`):$.toast(`The crystal flickers and dims — that resonance is wrong.`),this.inputIndex=0,this.render()}}solve(){fu.close(),Q.setFlag(`kethra_mechanism_solved`),Q.addResource(`resonant_crystal`,3),Q.addAttributeXp(`archaeology`,2),ju.playChime(),$.toast(`The Cistern Heart wakes. Water and light flow through the terraces once more.`),this.onSolved()}},id=new K(2574906),ad=new K(5233034);function od(e,t,n,r,i,a=5917242){let o=new q(new qi(e,.6,t),new J({color:a,roughness:.85,metalness:.05}));return o.position.set(n,r,i),o.receiveShadow=!0,o}function sd(e,t,n,r=1.1){let i=new q(new Yi(r*.7,r,n,10),new J({color:3812898,roughness:.9}));return i.position.set(e,n/2,t),i.castShadow=!0,i}var cd=class{scene=new Nn;camera=new Ua(65,window.innerWidth/window.innerHeight,.05,800);player;interaction=new Tu;onDepart=null;floorMeshes=[];canopyMats=[];creature;creatureTime=0;mechanismCore;mechanismLight;waterPool;puzzle=new rd;unsub=[];stopAmbient=null;constructor(){this.player=new Su(this.camera,new U(0,2,18)),this.creature=new q(new Qi(.7,1),new J({color:8970440,emissive:4184488,emissiveIntensity:1.6,roughness:.3}))}async init(){this.scene.background=new K(725536),this.scene.fog=new Mn(725536,.018),this.scene.environment=Ul(),this.scene.environmentIntensity=.5,Q.data.journalLogs.length>0&&!Q.data.journalLogs.some(e=>e.id===Qu[0]?.id)&&Q.data.journalLogs.push(...Qu.map(e=>({...e}))),this.buildGround(),this.buildTerraces(),this.buildCanopy(),this.buildNPCs(),this.buildFragments(),this.buildShrineAndValve(),this.buildCreatureArea(),this.buildMechanismChamber(),this.buildReturnPad(),this.buildClutter(),this.buildAtmosphere(),this.buildLighting(),this.scene.add(this.player.rig),this.player.setFloorTargets(this.floorMeshes),this.player.setColliders(this.colliders()),this.player.teleport(new U(0,2,18),0),this.player.onFootstep=()=>ju.playFootstep(`organic`),this.stopAmbient=ju.startAmbient(96,.03),this.interaction.onPromptChange=e=>$.setPrompt(e),this.unsub.push(Z.on(`player:shake`,e=>this.player.addShake(e))),this.puzzle.onSolved=()=>this.setCanopyBright(!0),Q.hasFlag(`kethra_mechanism_solved`)&&this.setCanopyBright(!0),Q.setObjective(`Explore Kethra. Speak with the Aiveth and find the true light-sequence.`)}buildGround(){let e=new q(new ea(600,600),new J({color:793108,roughness:1}));e.rotation.x=-Math.PI/2,e.position.y=-20,this.scene.add(e),this.floorMeshes.push(e)}buildTerraces(){let e=od(10,10,0,0,16),t=od(16,16,0,0,2),n=od(4,8,-7,-.1,10);n.rotation.x=-.12;let r=od(10,9,-16,.6,-2),i=od(4,8,7,-.1,10);i.rotation.x=-.12;let a=od(10,9,16,.6,-2),o=od(8,10,0,1.1,-14,4536906);for(let s of[e,t,n,r,i,a,o])this.scene.add(s),this.floorMeshes.push(s);let s=od(3,3,-20,2.4,-8,3820122);this.scene.add(s),this.floorMeshes.push(s)}buildCanopy(){for(let[e,t,n]of[[-8,0,4],[8,0,4],[-16,.6,-6],[16,.6,-6],[-4,1.1,-18],[4,1.1,-18]]){let r=9+Math.random()*3,i=sd(e,n,r);i.position.y=t+r/2,this.scene.add(i);let a=new J({color:id.clone(),emissive:id.clone(),emissiveIntensity:.8,roughness:.6});this.canopyMats.push(a);let o=new q(new Qi(2.4+Math.random(),1),a);o.position.set(e,t+r+1.2,n),o.scale.y=.6,this.scene.add(o)}}addNPC(e,t,n,r){let i=new wn,a=new q(new Ji(.4,1.3,6,10),new J({color:n,roughness:.55,metalness:.1}));a.position.y=1.05,i.add(a);let o=new q(new na(.16,12,12),new J({color:r,emissive:r,emissiveIntensity:2}));o.position.y=2.05,i.add(o);let s=new Ga(r,1.2,4);return s.position.y=2.05,i.add(s),i.position.set(e,.6,t),this.scene.add(i),i}buildNPCs(){let e=this.addNPC(-3,3,5917290,14241647);this.interaction.register({object:e,label:`Speak with the Warden`,range:2.4,onInteract:()=>Ju.start(Xu)});let t=this.addNPC(3,4,4876890,5233096);this.interaction.register({object:t,label:`Speak with the Archivist`,range:2.4,onInteract:()=>Ju.start(Zu)})}buildFragments(){[[-16,1.4,-3],[16,1.4,-3],[-20,3.2,-8]].forEach(([e,t,n],r)=>{let i=new q(new Yi(.3,.35,1.4,8),new J({color:2761752,roughness:.8}));i.position.set(e,t,n),this.scene.add(i);let a=new q(new ea(.6,.6),new J({color:14272650,emissive:14272650,emissiveIntensity:1.2,side:2}));a.position.set(e,t+.9,n),a.rotation.y=Math.PI/4,this.scene.add(a);let o=Qu[r],s=`kethra_fragment_${r+1}_read`;this.interaction.register({object:i,label:`Read Inscription${r+1<=3?` ${r+1}`:``}`,range:2.2,onInteract:()=>{Q.setFlag(s),o&&(Q.unlockLog(o.id),Q.addClue({id:o.id,title:o.title,summary:o.body.slice(0,80),source:`Kethra inscription`}),Q.addAttributeXp(`archaeology`,1),$.toast(`Inscription recorded: ${o.title}`))}})})}buildShrineAndValve(){let e=new q(new ra(.35,.1,8,16),new J({color:6969914,metalness:.7,roughness:.4}));e.position.set(2.5,.9,8),e.rotation.x=Math.PI/2,this.scene.add(e),this.interaction.register({object:e,label:()=>Q.hasFlag(`kethra_helped_with_valve`)?`Valve Already Repaired`:`Realign the Lower Valve`,range:2.2,onInteract:()=>{if(Q.hasFlag(`kethra_helped_with_valve`)){$.toast(`The valve turns smoothly. Water still trickles through, thin but steady.`);return}Q.setFlag(`kethra_helped_with_valve`),Q.addAttributeXp(`engineering`,1),$.toast(`You realign the corroded valve. A thin trickle of water resumes down the terrace.`)}});let t=new q(new Xi(.7,1.6,6),new J({color:4864602,emissive:9071321,emissiveIntensity:.5,roughness:.6}));t.position.set(-1.5,.8,5),this.scene.add(t);let n=Qu.find(e=>e.id===`kethra_ritual_record`);this.interaction.register({object:t,label:`Examine the Grove Shrine`,range:2.2,onInteract:()=>{n&&(Q.unlockLog(n.id),Q.addClue({id:n.id,title:n.title,summary:n.body.slice(0,80),source:`Kethra shrine record`}),$.toast(`Grove record recovered: ${n.title}`))}})}buildCreatureArea(){this.creature.position.set(0,2.4,-11),this.scene.add(this.creature);let e=new Ga(4184488,1.5,6);this.creature.add(e);let t=new q(new na(1.1,12,12),new J({color:4184458,emissive:4184458,emissiveIntensity:1.4}));t.position.set(-4,2.5,-10),t.userData.dormant=!1,this.scene.add(t);let n=new Ga(4184458,2,7);t.add(n),this.interaction.register({object:t,label:()=>Q.hasFlag(`kethra_grove_dimmed`)?`Restore the Grove Light`:`Dim the Grove Light`,range:2.4,onInteract:()=>{Q.hasFlag(`kethra_grove_dimmed`)?(Q.data.flags=Q.data.flags.filter(e=>e!==`kethra_grove_dimmed`),t.material.emissiveIntensity=1.4,n.intensity=2,$.toast(`The grove light returns. The guardian stirs.`)):(Q.setFlag(`kethra_grove_dimmed`),t.material.emissiveIntensity=.15,n.intensity=.15,$.toast(`The grove dims. The guardian grows still and drowsy.`))}})}buildMechanismChamber(){this.mechanismCore=new q(new $i(1.3,0),new J({color:9075673,emissive:5918681,emissiveIntensity:1.2,roughness:.2,metalness:.4})),this.mechanismCore.position.set(0,2.2,-18),this.scene.add(this.mechanismCore),this.mechanismLight=new Ga(9075673,2.5,10),this.mechanismLight.position.copy(this.mechanismCore.position),this.scene.add(this.mechanismLight),this.waterPool=new q(new ta(1.6,3.4,32),new J({color:4161456,emissive:2776970,emissiveIntensity:.3,roughness:.15,metalness:.6,transparent:!0,opacity:.12})),this.waterPool.rotation.x=-Math.PI/2,this.waterPool.position.set(0,1.42,-18),this.scene.add(this.waterPool);let e=new q(new qi(1.6,1,.8),new J({color:2761784,roughness:.5,metalness:.3}));e.position.set(0,1.9,-16),this.scene.add(e),this.interaction.register({object:e,label:`Access the Cistern Heart`,range:3,onInteract:()=>{if(!Q.hasFlag(`kethra_grove_dimmed`)&&!Q.hasFlag(`kethra_mechanism_solved`)){$.toast(`The guardian is too alert to risk this now. Something nearby keeps it awake.`);return}this.puzzle.open()}});let t=new q(new qi(1.2,1.8,.3),new J({color:1841168,roughness:.9}));t.position.set(-2.6,2.3,-17.5),t.rotation.y=.3,this.scene.add(t);let n=Qu.find(e=>e.id===`kethra_kindling_record`);this.interaction.register({object:t,label:`Read the Last Kindling Carving`,range:2.8,onInteract:()=>{n&&(Q.unlockLog(n.id),Q.addClue({id:n.id,title:n.title,summary:n.body.slice(0,80),source:`Deep chamber carving`}),Q.addAttributeXp(`insight`,1),$.toast(`Carving deciphered: ${n.title}`))}})}buildReturnPad(){let e=new q(new Yi(1.6,1.6,.15,20),new J({color:5594986,emissive:2785241,emissiveIntensity:.5,metalness:.6,roughness:.4}));e.position.set(0,.1,18),this.scene.add(e),this.interaction.register({object:e,label:`Return to Ship`,range:2.6,onInteract:()=>this.onDepart?.()})}buildAtmosphere(){let e=new Float32Array(1500);for(let t=0;t<500;t++)e[t*3]=(Math.random()-.5)*60,e[t*3+1]=Math.random()*12,e[t*3+2]=(Math.random()-.5)*60-5;let t=new Dr;t.setAttribute(`position`,new fr(e,3));let n=new Bi(t,new Fi({color:10479816,size:.06,transparent:!0,opacity:.6}));n.name=`motes`,this.scene.add(n)}buildLighting(){let e=new Ya(6255240,1.1);this.scene.add(e);let t=new Ja(10070749,1.3);t.position.set(10,20,5),this.scene.add(t);let n=new Ga(9099704,2,20);n.position.set(0,5,4),this.scene.add(n)}colliders(){let e=[];for(let[t,n]of[[-8,4],[8,4],[-16,-6],[16,-6],[-4,-18],[4,-18]])e.push(new Jn(new U(t-.9,0,n-.9),new U(t+.9,6,n+.9)));return e.push(new Jn(new U(-1,0,-19),new U(1,3.5,-17))),e}setCanopyBright(e){let t=e?ad:id;for(let n of this.canopyMats)n.color.copy(t),n.emissive.copy(t),n.emissiveIntensity=e?1.8:.8;let n=this.waterPool.material;n.opacity=e?.55:.12,n.emissiveIntensity=e?.9:.3}buildClutter(){let e=new J({color:4867128,roughness:.9,metalness:.05}),t=new J({color:3103295,roughness:.75,emissive:1718824,emissiveIntensity:.25});for(let[n,r,i,a,o]of[[-6,6,-5,8,.3],[12,20,-6,2,.9],[-20,-12,-6,2,.9]])for(let s=0;s<7;s++){let s=n+Math.random()*(r-n),c=i+Math.random()*(a-i);if(Math.random()>.5){let t=new q(new Qi(.18+Math.random()*.22,0),e);t.position.set(s,o+.15,c),t.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI),this.scene.add(t)}else{let e=new q(new Xi(.22+Math.random()*.15,.5+Math.random()*.3,6),t);e.position.set(s,o+.3,c),this.scene.add(e)}}}update(e,t){this.player.update(e),this.interaction.update(this.camera),this.creatureTime+=e;let n=Q.hasFlag(`kethra_grove_dimmed`)||Q.hasFlag(`kethra_mechanism_solved`),r=this.creature.material;n?(r.emissiveIntensity=.4,this.creature.position.y=2+Math.sin(this.creatureTime*.5)*.05):(r.emissiveIntensity=1.6+Math.sin(t*3)*.4,this.creature.position.x=Math.sin(this.creatureTime*.6)*4,this.creature.position.y=2.4+Math.sin(this.creatureTime*1.4)*.3),this.mechanismCore.rotation.y+=e*.4,this.mechanismLight.intensity=Q.hasFlag(`kethra_mechanism_solved`)?4+Math.sin(t*2)*.5:2.5;let i=this.scene.getObjectByName(`motes`);i&&(i.rotation.y+=e*.01)}onResize(e,t){this.camera.aspect=e/t,this.camera.updateProjectionMatrix()}dispose(){for(let e of this.unsub)e();this.stopAmbient?.(),this.interaction.clear(),this.scene.traverse(e=>{let t=e;t.geometry&&t.geometry.dispose()})}},ld=`kethra_save_v1`,ud={hasSave(){return localStorage.getItem(ld)!==null},save(){localStorage.setItem(ld,Q.toJSON())},load(){let e=localStorage.getItem(ld);if(!e)return!1;try{return Q.loadFrom(e),!0}catch{return!1}},clear(){localStorage.removeItem(ld)}};function dd(e){return new Promise(t=>setTimeout(t,e))}var fd=class{engine;shipScene=null;constructor(e){this.engine=e,Z.on(`galaxy:travel_to`,e=>this.travelToPlanet(e));for(let e of[`ship:repaired`,`level:up`,`log:unlocked`,`clue:added`])Z.on(e,()=>ud.save())}async travelToPlanet(e){if(e!==`kethra`){$.toast(`Scanner range insufficient for that destination.`);return}await $.fadeToBlack();let t=new cd;t.onDepart=()=>this.returnFromPlanet(),await this.engine.setScene(()=>t),await $.fadeFromBlack()}async returnFromPlanet(){await $.fadeToBlack(),this.shipScene=new Fu,await this.engine.setScene(()=>this.shipScene),await $.fadeFromBlack(),Q.setObjective(`Repair the ship, or chart a course to explore further.`),ud.save()}async start(){if(this.shipScene=new Fu,await this.engine.setScene(()=>this.shipScene),this.engine.start(),Q.hasFlag(`tutorial_battle_complete`)){this.finishReturnToShip();return}this.runOpening()}async runOpening(){await dd(1400),$.showLetterbox(!0),$.showCaption(`Life support online. Navigation and hyperdrive: dark.`,2400),await dd(2400),$.showCaption(`Unidentified contact detected on long-range scan.`,2200),await dd(1900),$.showLetterbox(!1),$.clearCaption(),this.startBattle()}startBattle(){if(!this.shipScene)return;this.shipScene.player.enabled=!1,Rl.exitPointerLock();let e=new qu;e.onWin=()=>{this.shipScene&&(this.shipScene.player.enabled=!0),this.transitionToGalaxyReveal()},e.start()}async transitionToGalaxyReveal(){await $.fadeToBlack();let e=new Uu;e.onContinue=()=>this.finishReveal(),await this.engine.setScene(()=>e),await $.fadeFromBlack()}async finishReveal(){Q.setFlag(`galaxy_revealed`),Q.data.planetsUnlocked.includes(`kethra`)||Q.data.planetsUnlocked.push(`kethra`),Q.setFlag(`logs_available`),Q.setFlag(`damage_assessed`),await $.fadeToBlack(),this.shipScene=new Fu,await this.engine.setScene(()=>this.shipScene),await $.fadeFromBlack(),this.finishReturnToShip()}async finishReturnToShip(){Q.setObjective(`Review the travel logs, repair the ship, and chart a course to Kethra.`),$.toast(`Travel Logs restored.`),await dd(1300),$.toast(`Ship Repair interface online.`),await dd(1300),$.toast(`Galaxy Map calibrated — Kethra is in range.`),ud.save()}};function pd(e,t){return[e,t].sort().join(`|`)}var md={[pd(`kethra_clue_kindling_vanishing`,`kethra_clue_ship_echo`)]:`The Kindling vanished the same way your own ship was thrown off course — every light called home in a single breath, everywhere, at once. This has happened before.`},hd=[{id:`log_departure`,title:`Departure — Personal Log 1`,body:`"Cleared the outer beacons at 0600. Cargo manifest confirms the survey equipment made it aboard intact this time. Three months chasing a rumor is a long way to go, but if the source is right about what's out past the Kessic Drift, it'll be worth every day of it. Setting a course into the dark."`,corrupted:!1,timestamp:`Day 1`,unlocked:!0},{id:`log_deviation`,title:`Course Deviation — Personal Log 14`,body:`"Something's wrong with the deep-space charts out here. The nav computer keeps re-solving for a route that shouldn't exist — like there's a mass out there that isn't on any survey. I changed heading twice tonight just to convince myself I wasn't imagining the drift."`,corrupted:!1,timestamp:`Day 14`,unlocked:!0},{id:`log_signal`,title:`Unknown Signal — Personal Log 22`,body:`"Picked up ▓▓▓▓ repeating ▓▓▓▓ not in any catalog. Structure to it — too regular for background noise. Recording for ▓▓▓▓ later. Whatever it is, it's close."`,corrupted:!0,timestamp:`Day 22`,unlocked:!0},{id:`log_final`,title:`Final Entry Before Silence`,body:`"▓▓▓▓ the light came from everywhere at once, no direction to point the sensors at. Hull integrity ▓▓▓▓. I don't— [DATA CORRUPTED] —if anyone finds this, we were never supposed to—"`,corrupted:!0,timestamp:`Day 23`,unlocked:!0}],gd=new class{view=`logs`;selectedLogId=null;selectedClueIds=[];init(){Q.data.journalLogs.length===0&&(Q.data.journalLogs=hd.map(e=>({...e}))),Z.on(`ui:open_journal`,()=>this.open()),Z.on(`evidence:pair_selected`,e=>this.tryConnect(e.a,e.b))}tryConnect(e,t){let n=pd(e,t);if(Q.data.clueConnections.some(e=>pd(e.a,e.b)===n)){$.toast(`You have already connected these clues.`);return}let r=md[n];r?(Q.connectClues(e,t,r),Q.addAttributeXp(`insight`,1),ju.playChime(),$.toast(`New connection recorded on the evidence board.`)):$.toast(`No clear connection between these — yet.`),this.render()}open(e=`logs`){this.view=e,this.selectedLogId=Q.data.journalLogs.find(e=>e.unlocked)?.id??null,this.render()}render(){let e=document.createElement(`div`);e.className=`panel`,e.id=`journal-panel`,e.style.position=`relative`;let t=document.createElement(`div`);t.style.cssText=`position:absolute; top:20px; right:32px; display:flex; gap:8px;`;for(let e of[`logs`,`evidence`]){let n=document.createElement(`button`);n.className=`text-btn`,n.style.textDecoration=this.view===e?`underline`:`none`,n.style.opacity=this.view===e?`1`:`0.6`,n.textContent=e===`logs`?`Travel Logs`:`Evidence Board`,n.onclick=()=>{this.view=e,this.render()},t.appendChild(n)}e.appendChild(t),this.view===`logs`?e.appendChild(this.renderLogsView()):e.appendChild(this.renderEvidenceView());let n=document.createElement(`div`);n.className=`close-hint`,n.textContent=`ESC to close`,e.appendChild(n),fu.open(e)}renderLogsView(){let e=document.createElement(`div`);e.style.cssText=`display:flex; gap:20px; width:100%; height:100%;`;let t=document.createElement(`h2`);t.textContent=`Travel Logs`;let n=document.createElement(`div`);n.className=`subtitle`,n.textContent=`Some entries are corrupted — pieces of the truth are still missing.`;let r=document.createElement(`div`);r.className=`journal-col`;for(let e of Q.data.journalLogs){if(!e.unlocked)continue;let t=document.createElement(`div`);t.className=`journal-entry`+(e.corrupted?` corrupted`:``),t.innerHTML=`<div class="title">${e.title}</div><div class="meta">${e.timestamp}${e.corrupted?` · corrupted`:``}</div>`,t.onclick=()=>{this.selectedLogId=e.id,this.render()},r.appendChild(t)}let i=document.createElement(`div`);i.className=`journal-detail`;let a=Q.data.journalLogs.find(e=>e.id===this.selectedLogId);a?i.innerHTML=`<strong>${a.title}</strong><div style="margin-top:10px;">${a.corrupted?`<span class="corrupt-text">${a.body}</span>`:a.body}</div>`:i.textContent=`No log selected.`;let o=document.createElement(`div`);o.style.cssText=`display:flex; flex-direction:column; width:100%;`,o.appendChild(t),o.appendChild(n);let s=document.createElement(`div`);return s.style.cssText=`display:flex; gap:20px; flex:1; overflow:hidden;`,s.appendChild(r),s.appendChild(i),o.appendChild(s),e.appendChild(o),e}renderEvidenceView(){let e=document.createElement(`div`);e.style.cssText=`display:flex; flex-direction:column; width:100%;`;let t=document.createElement(`h2`);t.textContent=`Evidence Board`;let n=document.createElement(`div`);n.className=`subtitle`,n.textContent=Q.data.clues.length>0?`Select two clues to connect them and record an insight.`:`No clues discovered yet. Explore to find them.`,e.appendChild(t),e.appendChild(n);let r=document.createElement(`div`);r.id=`evidence-board`;for(let e of Q.data.clues){let t=document.createElement(`span`);t.className=`clue-node`+(this.selectedClueIds.includes(e.id)?` selected`:``),t.textContent=e.title,t.title=e.summary,t.onclick=()=>this.toggleClueSelection(e.id),r.appendChild(t)}e.appendChild(r);let i=document.createElement(`div`);return i.id=`evidence-connections`,Q.data.clueConnections.length>0&&(i.innerHTML=`<strong>Connections made:</strong><br>`+Q.data.clueConnections.map(e=>`• ${e.insight}`).join(`<br>`)),e.appendChild(i),e}toggleClueSelection(e){if(this.selectedClueIds.includes(e))this.selectedClueIds=this.selectedClueIds.filter(t=>t!==e);else if(this.selectedClueIds.push(e),this.selectedClueIds.length===2){let[e,t]=this.selectedClueIds;Z.emit(`evidence:pair_selected`,{a:e,b:t}),this.selectedClueIds=[]}this.render()}},_d=class{init(){Z.on(`ui:open_repair`,()=>this.open())}open(){this.render()}render(){let e=document.createElement(`div`);e.className=`panel`,e.id=`repair-panel`;let t=document.createElement(`h2`);t.textContent=`Ship Repair Interface`,e.appendChild(t);let n=document.createElement(`div`);n.className=`subtitle`,n.textContent=`Route salvaged materials into damaged systems to restore ship function.`,e.appendChild(n);let r=Object.keys(Q.data.shipSystems);for(let t of r){let n=Q.data.shipSystems[t],r=document.createElement(`div`);r.className=`repair-row`;let i=document.createElement(`div`);i.className=`name`,i.textContent=n.label;let a=document.createElement(`div`);a.className=`status`+(n.repaired?` done`:``),a.textContent=n.repaired?`Operational`:n.requiredResource?`${n.haveAmount}/${n.requiredAmount} ${vd(n.requiredResource)}`:`Nominal`;let o=document.createElement(`div`);o.className=`bar-track`;let s=document.createElement(`div`);s.className=`bar-fill`,s.style.width=`${n.progress}%`,o.appendChild(s);let c=document.createElement(`button`);c.textContent=n.repaired?`Repaired`:`Repair`,c.disabled=n.repaired||!Q.canRepair(t),c.onclick=()=>{Q.repairSystem(t)&&($.toast(`${n.label} repaired.`),this.render())},r.appendChild(i),r.appendChild(a),r.appendChild(o),r.appendChild(c),e.appendChild(r)}let i=document.createElement(`div`);i.className=`close-hint`,i.textContent=`ESC to close`,e.appendChild(i),fu.open(e)}};function vd(e){return e.split(`_`).map(e=>e[0].toUpperCase()+e.slice(1)).join(` `)}var yd=new _d,bd=new class{init(){Z.on(`ui:open_galaxy_map`,()=>this.open())}open(){this.render()}render(){let e=document.createElement(`div`);e.className=`panel`,e.style.position=`relative`,e.style.padding=`24px`;let t=document.createElement(`h2`);t.textContent=`Galaxy Map`,e.appendChild(t);let n=document.createElement(`div`);n.className=`subtitle`,n.textContent=`Select a destination. Scanner range limits how far you can safely travel.`,e.appendChild(n);let r=document.createElement(`div`);r.id=`galaxy-map-panel`;let i=document.createElement(`div`);i.style.cssText=`position:absolute; left:8%; top:15%; width:36px; height:36px; border-radius:50%; background:radial-gradient(circle, #ffe3ab, #d9a441); box-shadow: 0 0 30px rgba(217,164,65,0.6);`,r.appendChild(i);for(let e of Ru){let t=Q.data.planetsUnlocked.includes(e.id),n=document.createElement(`div`);n.className=`planet-node`+(t?``:` locked`),n.style.left=`${e.mapX}%`,n.style.top=`${e.mapY}%`,n.style.background=`radial-gradient(circle at 35% 30%, #${(e.color+2236962).toString(16).padStart(6,`0`)}, #${e.color.toString(16).padStart(6,`0`)})`,n.innerHTML=`<div class="planet-label">${e.name}${t?``:` — out of range`}</div>`,t&&(n.onclick=()=>{fu.close(),Z.emit(`galaxy:travel_to`,e.id)}),r.appendChild(n)}e.appendChild(r);let a=document.createElement(`div`);a.className=`close-hint`,a.textContent=`ESC to close`,e.appendChild(a),fu.open(e)}},xd={insight:{label:`Insight`,description:`Connects disparate clues into new conclusions on the evidence board.`},archaeology:{label:`Archaeology`,description:`Reveals the true meaning of artifacts, ruins, and symbol systems.`},engineering:{label:`Engineering`,description:`Understands and safely manipulates ancient and ship mechanisms.`},traversal:{label:`Traversal`,description:`Opens riskier climbs, ledges, and shortcuts through the environment.`},persuasion:{label:`Persuasion`,description:`Unlocks additional dialogue options and hidden information from NPCs.`},perception:{label:`Perception`,description:`Reveals hidden objects, clues, and environmental anomalies.`}},Sd=new class{keyHandler=e=>{e.code===`Tab`&&(e.preventDefault(),fu.isOpen||this.open())};init(){window.addEventListener(`keydown`,this.keyHandler),Z.on(`level:up`,e=>$.toast(`Level up! You are now level ${e}. Skill point available.`))}open(){this.render()}render(){let e=document.createElement(`div`);e.className=`panel`,e.style.width=`520px`;let t=document.createElement(`h2`);t.textContent=`Explorer — Level ${Q.data.level}`,e.appendChild(t);let n=document.createElement(`div`);n.className=`subtitle`,n.textContent=`${Q.data.xp} / ${Q.data.level*100} XP to next level${Q.data.unspentPoints>0?` — ${Q.data.unspentPoints} unspent point(s)`:``}`,e.appendChild(n);let r=Object.keys(xd);for(let t of r){let n=xd[t],r=Q.data.attributes[t],i=document.createElement(`div`);i.className=`repair-row`,i.style.alignItems=`flex-start`,i.innerHTML=`
        <div style="flex:1;">
          <div class="name">${n.label} <span style="color:var(--accent)">${r}</span></div>
          <div class="status" style="margin-top:2px;">${n.description}</div>
        </div>`,e.appendChild(i)}let i=document.createElement(`div`);i.style.cssText=`display:flex; gap:10px; margin-top:18px;`;let a=document.createElement(`button`);a.className=`text-btn`,a.textContent=`Save Progress`,a.onclick=()=>{ud.save(),$.toast(`Progress saved.`)};let o=document.createElement(`button`);o.className=`text-btn`,o.textContent=`Load Last Save`,o.disabled=!ud.hasSave(),o.style.opacity=o.disabled?`0.4`:`1`,o.onclick=()=>{ud.load()&&($.toast(`Save loaded.`),this.render())},i.appendChild(a),i.appendChild(o),e.appendChild(i);let s=document.createElement(`div`);s.className=`close-hint`,s.textContent=`TAB or ESC to close`,e.appendChild(s),fu.open(e)}dispose(){window.removeEventListener(`keydown`,this.keyHandler)}},Cd=new ou(document.getElementById(`app`));$.init(),fu.mount(),ju.init(),gd.init(),yd.init(),bd.init(),Sd.init();var wd=new URLSearchParams(location.search);wd.get(`newGame`)?ud.clear():ud.hasSave()&&(ud.load(),$.toast(`Continuing your saved journey.`)),wd.get(`skipIntro`)&&Q.setFlag(`tutorial_battle_complete`),wd.get(`unlockKethra`)&&(Q.setFlag(`galaxy_revealed`),Q.setFlag(`logs_available`),Q.setFlag(`damage_assessed`),Q.data.planetsUnlocked.includes(`kethra`)||Q.data.planetsUnlocked.push(`kethra`));var Td=new fd(Cd);Td.start(),window.__DEBUG__={engine:Cd,flow:Td,gameState:Q,bus:Z};